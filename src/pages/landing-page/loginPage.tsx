...
export default function LoginPage() {
  ...
  return (
    ...
    <div className="min-h-screen items-center justify-center p-6 antialiased relative overflow-hidden"
    style={{
        backgroundImage:
          ...
          <Card className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl shadow-lg p-8">
            ...
            <CardContent className="space-y-4">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#f6c178] to-[#aacde5] text-black hover:brightness-110 hover:shadow-[0_0_25px_rgba(246,193,120,0.4)] transition-all duration-300" 
                  disabled={loading}
                >
                  {loading ? (
                ...
                <p className="text-sm text-center text-white/70">
                  Don’t have an account? <a onClick={()=>navigate('/register')} className="underline cursor-pointer">Sign Up</a>
                </p>
              </form>
            </CardContent>
          </Card>
